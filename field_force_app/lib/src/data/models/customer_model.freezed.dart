...
class _$CustomerModelImpl extends _CustomerModel {
  ...
  @override
  String toString() {
    return 'CustomerModel(localId: $localId, serverId: $serverId, name: $name, address: $address, city: $city, latitude: $latitude, longitude: $longitude, lastVisit: $lastVisit, pendingActivities: $pendingActivities, syncStatus: $syncStatus, updatedAt: $updatedAt)';
  }
