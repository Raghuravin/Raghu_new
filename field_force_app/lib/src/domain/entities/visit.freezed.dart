...
mixin _$VisitEntity {
  ...
  /// Serializes this VisitEntity to a JSON map.
...
class _$VisitEntityImpl implements _VisitEntity {
  ...
  Map<String, dynamic> toJson() {
    return _$$VisitEntityImplToJson(this);
  }
}
